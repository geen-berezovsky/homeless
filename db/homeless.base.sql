...
INSERT INTO `ServicesType` VALUES (1, 'Консультация', 0, 0, 1),(2, 'Продукты', 0, 0, 2),(3, 'Комплект одежды', 0, 0, 3),(4, 'Получена корреспонденция', 0, 0, 5),(5, 'Передана корреспонденция', 0, 0, 6),(6, 'Покупка лекарств', 1, 0, 7),(11, 'Справка о регистрации', 0, 1, 0),(12, 'Направление на санобработку', 0, 1, 0),(13, 'Справка для проезда', 0, 1, 0),(14, 'Направление в диспансер', 0, 1, 0),(15, 'Справка социальная помощь', 0, 1, 0),(16, 'Изготовление фотографий', 0, 0, 8),(17, 'Написание заявлений/запросов', 0, 0, 9),(18, 'Оплата проезда', 1, 0, 10),(19, 'Консультация психолога', 0, 0, 11),(20, 'Оплата пошлины', 1, 0, 12),(21, 'Средства гигиены', 0, 0, 4),(100, 'Справка Транзит', 0, 1, 0);
