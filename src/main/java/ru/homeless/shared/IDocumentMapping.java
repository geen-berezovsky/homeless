...
public interface IDocumentMapping {
    ...
    public final String DOCUMENT_SOCIAL_HELP_TEMPLATE_PATH = "WEB-INF/templates/documents/DocumentSocialHelp.docx";
    ...
    public final String DOCUMENT_FREE_TRAVEL_TEMPLATE_PATH = "WEB-INF/templates/documents/DocumentFreeTravel.docx";
    ...
    public final String DOCUMENT_SANITATION_TEMPLATE_PATH = "WEB-INF/templates/documents/DocumentSanitation.docx";
