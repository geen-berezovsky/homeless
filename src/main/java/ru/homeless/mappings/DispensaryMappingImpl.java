 ...
 */
public class DispensaryMappingImpl implements ICustomMapping {

    @Override
    public WordprocessingMLPackage getDocument(Map map) {
        return new DocTypeProcessor(map, IDocumentMapping.DOCUMENT_DISPENSARY_TEMPLATE_PATH).replaceParametersInDocument(null,0);
    }
