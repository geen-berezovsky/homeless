 ...
 */
public class RegistrationMappingImpl implements ICustomMapping {

    @Override
    public WordprocessingMLPackage getDocument(Map map) {
        return new DocTypeProcessor(map, IDocumentMapping.DOCUMENT_REGISTRATION_TEMPLATE_PATH).replaceParametersInDocument(null,0);
    }
